...
import Button from '@mui/material/Button'; // Import Button for menu items
...
export default function PrimarySearchAppBar() {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ backgroundColor: 'white', color: '#4E3B31' }}>
        <Toolbar>
          <IconButton
            size="large"
            edge="start"
            ...
            sx={{ mr: 2 }}
            onClick={handleMenuToggle} // Toggle mobile menu
          >
            <MenuIcon />
          </IconButton>
          <Typography
